...
function(a) {
    ...
    function c(c) {
        ...
        this.remove = function(a) {
            if (null == a)
                throw new Error("Stage.remove����: ����Ϊnull!");
            for (var b = 0; b < this.childs.length; b++)
                if (this.childs[b] === a)
                    return a.stage = null,
...
function(a) {
    function b(c) {
        ...
        this.paintAlarmText = function(a) {
            if (null != this.alarm && "" != this.alarm) {
                var b = this.alarmColor || "255,0,0"
                  , c = this.alarmAlpha || .5;
                a.beginPath(),
                a.font = this.alarmFont || "10px ΢���ź�";
                var d = a.measureText(this.alarm).width + 6
                  , e = a.measureText("��").width + 6
                  , f = this.width / 2 - d / 2
                  , g = -this.height / 2 - e - 8;
        ...
        this.setImage = function(a, b) {
            if (null == a)
                throw new Error("Node.setImage(): ����Image����Ϊ��!");
            var c = this;
            if ("string" == typeof a) {
                var d = j[a];
                null == d ? (d = new Image,
    ...
    function d(a) {
        ...
        this.paint = function(a) {
            ...
            this.height = a.measureText("��").width,
            a.strokeStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")",
            a.fillStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")",
    ...
    function h(a, b, c, d) {
        ...
        this.getPath = function(a) {
            ...
            var d = []
                ...
                , inInx1 = this.inInx1
                , inIny1 = this.inIny1
                , inOutx1 = this.inOutx1
                , inOuty1 = this.inOuty1
                , outInx1 = this.outInx1
                , outIny1 = this.outIny1
                , outOutx1 = this.outOutx1
                , outOuty1 = this.outOuty1;
